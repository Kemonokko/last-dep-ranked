...
const losColClass = (losPl && losPl.color) ? 'faction-' + losPl.color : 'faction-default';
                ...
                <div class="match-winner-row" style="display: flex; align-items: center; gap: 8px; justify-content: flex-start; width: 42%;">
                    <span style="
                        ...
                        flex-shrink: 0;
                    "></span>
    <span class="clickable-name ${getPlayerColor(m.winner_username)}" onclick="event.stopPropagation(); openPlayerModal('${m.winner_username}')" style="font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; cursor: pointer;">
                        ${m.winner_username}
                    </span>
