...
<div style="display: flex; justify-content: space-between; width: 100%; align-items: center;">
    <!-- ПОБЕДИТЕЛЬ (теперь кликабельный) -->
    <div style="flex: 1; text-align: left; overflow: hidden;">
        ...
        <div style="color: #00ff00; font-size: 1.1em; font-weight: 900; margin-top: 2px;">+${m["elo+"]} (+${m.bonus})</div>
    </div>
    ...
    <!-- ПРОИГРАВШИЙ (теперь тоже кликабельный) -->
