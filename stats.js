...
const losColClass = losPl && losPl.color ? `faction-${losPl.color}` : 'faction-default';
                ...
                <div class="match-winner-row" style="display: flex; align-items: center; gap: 8px; justify-content: flex-start; width: 42%;">
                    <span style="
                        ...
                        flex-shrink: 0;
                    "></span>
                    <span class="clickable-name ${winColClass}" onclick="event.stopPropagation(); openPlayerModal('${m.winner_username}')" style="font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; cursor: pointer;">
                        ${m.winner_username}
                    </span>
                ...
                <div class="match-loser-row" style="display: flex; align-items: center; gap: 8px; justify-content: flex-end; width: 42%;">
                    ...
                    <span class="clickable-name ${losColClass}" onclick="event.stopPropagation(); openPlayerModal('${m.loser_username}')" style="font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align: right; cursor: pointer;">
                        ${m.loser_username}
                    </span>
                    <span style="
                        display: inline-block;
