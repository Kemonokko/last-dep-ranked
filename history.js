        ...
        <div class="match-card" ondblclick="window.deleteMatch('${m.id}')" 
            ...
            <div style="display: flex; justify-content: space-between; width: 100%; align-items: center;">
                ...
                <div style="flex: 1; text-align: left; overflow: hidden;">
                    <b class="nick-hover role-${winRole}" onclick="window.openProfile('${m.win}')" 
                       style="font-size: 1.15em; white-space: nowrap; color: white; cursor: pointer;">${m.win}</b>
                    <div style="color: #00ff00; font-size: 0.95em; font-weight: 900; margin-top: 2px;">+${m["elo+"]} (+${m.bonus})</div>
                </div>
                ...
                <div style="flex: 1; text-align: right; overflow: hidden;">
                    <b class="nick-hover role-${lossRole}" onclick="window.openProfile('${m.loss}')" 
                       style="font-size: 1.15em; white-space: nowrap; color: white; cursor: pointer;">${m.loss}</b>
